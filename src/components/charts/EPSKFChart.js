...
/**
 * <epskf-chart> — Visualizes the EPS-KF value of the reference project.
 * Matches the design of the "EPS-KF" area chart.
 */
export class EPSKFChart extends BaseComponent {
  constructor() {
    super();
    this._chart = null;
  }
    ...
    container.innerHTML = `
      <div class="bg-white rounded-[16px] p-6 border border-gray-100 shadow-sm w-full overflow-hidden">
        <div class="mb-6">
          ...
          <p class="text-[12px] text-gray-500 font-normal">https://www.reddit.com/r/graphic_design/</p>
        </div>
...
defineComponent('epskf-chart', EPSKFChart);
